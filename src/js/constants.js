...
const BLOCK_META = {
  h1: { label: 'Titre H1', w: 240, h: 58, content: 'Titre principal' },
  h2: { label: 'Titre H2', w: 215, h: 54, content: 'Titre de section' },
  h3: { label: 'Titre H3', w: 185, h: 50, content: 'Titre de sous-section' },
  h4: { label: 'Titre H4', w: 155, h: 46, content: 'Sous-sous-section' },
  h5: { label: 'Titre H5', w: 140, h: 42, content: 'Titre de niveau 5' },
  h6: { label: 'Titre H6', w: 130, h: 40, content: 'Titre de niveau 6' },
  p: { label: 'Paragraphe', w: 165, h: 40, content: 'Texte de paragraphe...' },
  ul: { label: 'Liste à puces', w: 220, h: 82, content: 'Élément 1\nÉlément 2\nÉlément 3' },
  ol: { label: 'Liste numérotée', w: 220, h: 82, content: 'Élément 1\nÉlément 2\nÉlément 3' },
  ...
  table: { label: 'Tableau', w: 360, h: 140, tableData: [['Col 1', 'Col 2', 'Col 3'], ['Cellule 1', 'Cellule 2', 'Cellule 3'], ['Cellule 4', 'Cellule 5', 'Cellule 6']], tableColWidths: null },
