...
const BLOCK_META = {
  h1: { label: 'Titre H1', w: 400, h: 90, content: 'Titre principal' },
  h2: { label: 'Titre H2', w: 380, h: 36, content: 'Titre de section' },
  h3: { label: 'Titre H3', w: 280, h: 30, content: 'Titre de sous-section' },
  h4: { label: 'Titre H4', w: 250, h: 28, content: 'Sous-sous-section' },
  h5: { label: 'Titre H5', w: 220, h: 26, content: 'Titre de niveau 5' },
  h6: { label: 'Titre H6', w: 200, h: 24, content: 'Titre de niveau 6' },
  p: { label: 'Paragraphe', w: 340, h: 80, content: 'Texte de paragraphe...' },
  ...
  link: { label: 'Lien hypertexte', w: 200, h: 50, linkText: 'Cliquez ici', linkUrl: 'https://example.com' },
  table: { label: 'Tableau', w: 360, h: 94, tableData: [['Col 1', 'Col 2', 'Col 3'], ['Cell', 'Cell', 'Cell'], ['Cell', 'Cell', 'Cell']] },
